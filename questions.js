...
const questions = [
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "Exits the function without a value",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question:
            "Which superhero is known for saying, 'I am Iron Man'?",
          options: [
            "Black Panther",
            "Captain America",
            "Thor",
        ...
        {
          question:
            "In which movie did Heath Ledger portray the Joker?",
          options: [
            "The Dark Knight",
            "Batman Begins",
        ...
        {
          question:
            "Who played the role of the Joker in the 2019 movie 'Joker'?",
          options: [
            "Heath Ledger",
            "Johnny Depp",
            "Joaquin Phoenix",
